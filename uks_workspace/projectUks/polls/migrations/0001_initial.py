    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subfolder', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='polls.Folder')),
            ],
            bases=('polls.object',),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='issue',
            name='repository',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='repository', to='repository.Repository'),
        ),
        migrations.AddField(
            model_name='comment',
            name='author_comment',
